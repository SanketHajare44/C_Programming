...
//  Description :   It is used to display addition of even Factors
//  Input :         Integer
//  Output :        Integer
                       ...
                       )
{
    ...
    return iSum;
}// End of Sum_of_Even_Factors function
...
{   
    ...
    iRet = Sum_of_Even_Factors(iValue);         // Function call

    printf("Addition of all even factor is : %d\n",iRet);
